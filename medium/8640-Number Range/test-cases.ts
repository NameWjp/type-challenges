...
type NumberToRange<T extends unknown[], H extends number, U = never> = T['length'] extends H
  ? U | T['length']
  : NumberToRange<[...T, unknown], H, U | T['length']>

type NumberRange<L extends number, H extends number> = NumberToRange<ConstructTuple<L>, H>
