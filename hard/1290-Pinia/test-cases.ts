...
type ComputedGetters<C extends Record<string, any>> = { readonly [K in keyof C]: ReturnType<C[K]> }

declare function defineStore<S, G extends Record<string, any>, A extends Record<string, any>>(
  options: {
    id: string,
    state(): S,
